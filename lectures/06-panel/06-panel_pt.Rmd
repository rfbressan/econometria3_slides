...
* ... está associado a um aumento na taxa de criminalidade de `r xsection_p[1]` para `r xsection_p[2]`, ou `r round(100 * diff(xsection_p) / xsection_p[1],2)` por cento de aumento na taxa de criminalidade.
